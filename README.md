...
ingredients, ordered instructions, timing/classification metadata, and household
notes, plus the first list management flows are in place. Product behavior such as recipe
