...
ingredients, and ordered instructions, and the first list management flows are
in place. Product behavior such as recipe parsing, ingredient normalization,
grocery calculations, collaboration, and moderation remains intentionally
deferred to the feature lanes described in the [scaffolding plan](docs/mvp/scaffolding-setup-instructions.md).
